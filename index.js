...
function createList() {
	...
	// run locally
    //$.get("http://localhost:7071/api/dashiawritecosmos", function(data, status){ 
    
    
	// run on Azure
    $.get("https://dashiacosmosdatawriter.azurewebsites.net/api/dashiawritecosmos", function(data, status){ 
